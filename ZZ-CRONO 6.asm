...
;ADMITE LA CARGA DEL REGISTRO DIG4 y DIG3 (EQU 23H Y 24H RESPECTIVAMENTE) POR PUERTO SERIE.
...
RESETEA CLRF	PORTA
		BCF 	INTCON, RBIF	; BAJA FLAG INT POR RB4
		BCF		INTCON,T0IE		; DESHABILITA INT POR TMR0
		BCF		INTCON,T0IF		; SE EVITA QUE LUEGO DEL RESETEO SE ATIENDA TOIF EN INCREMENTE EN UNA CENT
		CLRF	DIG1			;
		CLRF	DIG2			;
		CLRF	DIG3			;
		CLRF	DIG4			;
